...
pipe_naive = Pipeline([('vect', TfidfVectorizer()),
                       ('fs', SelectKBest()),
                       ('clf', MultinomialNB())])
...
def grid_search(data, pipeline, params):
    ...
    return report
#%%
results = grid_search(data, pipe_naive, search_grid)
#%%
results.to_excel(r"C:\Users\jackw\Desktop\FiCli\Model Results\Multinomial_Naive_Bayes.xlsx")
