...
# Set up pipeline with desired vectorizer and scikit model
pipe_rf = Pipeline([('vect', TfidfVectorizer()),
                       ('fs', SelectKBest()),
                       ('clf', RandomForestClassifier())])
    
# Set up desired paramater grid to be tested by GridSearchCV
search_grid = {
        'vect__ngram_range': [(1,1), (1,2), (2,2)],
        'vect__use_idf': (True, False),
        'fs__k': (2000, 5000, 'all'),
        'clf__n_estimators': [10, 150, 300],
...
#%%
results = grid_search(data, pipe_rf, search_grid)
#%%
results.to_excel(r"C:\Users\jackw\Desktop\FiCli\Model Results\RandomForest.xlsx")
