...
pipe_SGD = Pipeline([('vect', TfidfVectorizer()),
                     ('fs', SelectKBest()),
                       ('clf', SGDClassifier())])
# Test search grid
test_grid = {}
...
def grid_search(data, pipeline, params):
    ...
    return report
#%%
results = grid_search(data, pipe_SGD, search_grid)
#%%
results.to_excel(r"C:\Users\jackw\Desktop\FiCli\Model Results\SGD.xlsx")
