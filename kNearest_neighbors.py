...
from sklearn.metrics import precision_recall_fscore_support, classification_report, plot_confusion_matrix
from sklearn.pipeline import Pipeline
#%%
# Set Pipeline with vectorizer, feature selector, and model
pipe_knear = Pipeline([('vect', TfidfVectorizer()),
                       ('fs', SelectKBest()),
...
search_grid = {
        ...
        'clf__n_neighbors': (1, 10, 20),
        'clf__leaf_size': (1, 30, 50, 100),
        'clf__p': (1,2),
        'clf__weights': ('uniform', 'distance'),
        'clf__metric': ('cityblock', 'cosine' )#, 'euclidean', 'l1', 'l2', 'manhattan', 'precomputed')
        }
#%%
'''
...
#%%
results = grid_search(data, pipe_knear, search_grid)
#%%
results.to_excel(r"C:\Users\jackw\Desktop\FiCli\Model Results\kNearest_Neighbors.xlsx")